...
def inicializar_menu():
    ...
    pygame.display.set_caption("PAC-BOT LAB - MENÚ PRINCIPAL")
...
def seleccionar_mapa(nombre_modo):
    ...
    pygame.display.set_caption("PAC-BOT LAB - SELECCIÓN DE MAPA")
...
def main():
    ...
    while True:
        pantalla.fill(NEGRO)
        titulo = fuente_titulo.render("PAC-BOT LAB", True, AMARILLO)
        pantalla.blit(titulo, (ANCHO // 2 - titulo.get_width() // 2, 40))
